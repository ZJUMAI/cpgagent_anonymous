"""Run the Qwen-driven UCEC MRI ROI demo for case 03850333."""
...
CASE_ID = "03850333"
TARGET_SKILL = "radiology.ucec_mri_roi"
DEFAULT_PROMPT = (
    "For the current endometrial carcinoma case, use the available UCEC MRI ROI "
    "tool to export T2/DWI review images, inspect the generated slice and overlay "
    "PNG artifacts, then summarize what was produced. Clearly state that this is "
    "research model output rather than clinical advice."
)
...
def run_demo(
    *,
    ...
    """Run one Qwen turn and require the model to choose the UCEC MRI ROI skill."""
