"""Run the Qwen-driven NPC CONCH patch ROI demo for the synthetic NPC-DEMO case."""
...
CASE_ID = "NPC-DEMO"
TARGET_SKILL = "pathology.npc_conch_patch_roi"
DEFAULT_PROMPT = (
    "For the current nasopharyngeal carcinoma case, use the available NPC pathology "
    "CONCH patch ROI tool to select tumor-relevant pathology patch ROIs, inspect "
    "the generated contact sheet and patch images, then summarize what was "
    "produced. Clearly state that this is research model output rather than "
    "clinical advice."
)
...
def run_demo(
    *,
    ...
    """Run one Qwen turn and require the model to choose the NPC CONCH ROI skill."""
