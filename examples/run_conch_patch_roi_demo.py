"""Run the Qwen-driven pathology CONCH patch ROI demo for TCGA-38-4626."""
...
TARGET_SKILL = "pathology.conch_patch_roi"
DEFAULT_PROMPT = (
    "For the current lung cancer case, use the available pathology CONCH patch "
    "ROI tool to select tumor-relevant pathology patch ROIs, inspect the generated "
    "contact sheet and patch images, then summarize what was produced. Clearly "
    "state that this is research model output rather than clinical advice."
)
...
def run_demo(
    *,
    ...
    """Run one Qwen turn and require the model to choose the pathology ROI skill."""
