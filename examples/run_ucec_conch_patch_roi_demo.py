"""Run the Qwen-driven UCEC CONCH patch ROI demo for case 03850333."""
...
CASE_ID = "03850333"
TARGET_SKILL = "pathology.ucec_conch_patch_roi"
DEFAULT_PROMPT = (
    "For the current endometrial carcinoma case, use the available UCEC pathology "
...
def run_demo(
    *,
    ...
    """Run one Qwen turn and require the model to choose the UCEC CONCH ROI skill."""
