"""Run the Qwen-driven real CT lung tumor ROI demo for TCGA-38-4626."""
...
TARGET_SKILL = "radiology.lung_tumor_roi"
DEFAULT_PROMPT = (
    "For the current lung cancer case, use the available radiology tool to segment "
    "the lung tumor, select the largest tumor ROI, inspect the generated ROI, full "
    "axial slice, and overlay images, then summarize what was produced. Clearly state "
...
def run_demo(
    *,
    ...
    """Run one Qwen turn and require the model to choose the tumor ROI skill."""
