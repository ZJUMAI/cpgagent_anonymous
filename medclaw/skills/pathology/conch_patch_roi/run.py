"""MedClaw execution entrypoint for pathology.conch_patch_roi."""
...
from medclaw.skills.pathology.conch_patch_roi.workflow import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        result = {
            "status": "failed",
            "findings": {
                "summary": f"CONCH patch ROI skill failed: {exc}",
                "roi_selected": False,
                "error": str(exc),
            },
            "artifacts": [],
