"""MedClaw execution entrypoint for pathology.npc_conch_patch_roi."""
...
from medclaw.skills.pathology.npc_conch_patch_roi.workflow import (  # noqa: E402
    DEFAULT_TOP_K_PER_PROMPT,
    run_npc_conch_patch_roi,
)


SKILL_NAME = "pathology.npc_conch_patch_roi"
SKILL_VERSION = "0.1.0"
...
def execute(input_path: Path, output_path: Path) -> dict[str, Any]:
    ...
    workflow = run_npc_conch_patch_roi(
        case_id,
        output_path.parent,
...
def main() -> int:
    ...
    try:
        ...
        result = {
            "status": "failed",
            "findings": {
                "summary": f"NPC CONCH patch ROI skill failed: {exc}",
                "roi_selected": False,
                "error": str(exc),
            },
            "artifacts": [],
